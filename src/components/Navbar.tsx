...
const ToggleMode: React.FC = () => {
    ...
    const { r, transform, cx, cy, opacity } = theme === 'dark' ? properties['moon'] : properties['sun']
    ...
    return (
        <motion.div className="h-6 text-gray-500 dark:hover:text-white" variants={anims.Pfp}>
            <animated.svg
