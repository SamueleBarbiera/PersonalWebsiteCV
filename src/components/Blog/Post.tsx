...
export default function _Post({ index, frontmatter }: PostProps) {
            ...
            >
                ...
                <div
                    className={clsx(
                        ...
                        frontmatter.banner && index <= 2 && 'lg:rounded-tr-none lg:rounded-tl-none'
                    )}
                >
                    <div className="flex flex-col flex-1 justify-around rounded-lg text-gray-300 dark:text-gray-400 default-focus">
                        <h4 className="text-xl font-bold text-gray-900 dark:text-gray-100">{frontmatter.title}</h4>
                        {((frontmatter.description && frontmatter.description_show) || true) && (
                            <p aria-label={frontmatter.description} className="mt-3 text-base line-clamp-2">
