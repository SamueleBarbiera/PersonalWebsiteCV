    ...
    return (
        <>
            ...
            <LayoutDefault>
                ...
                <div
                    className="h-full flex items-center justify-center mx-auto rounded-lg shadow-xl m-8 p-8 w-min bg-gradient-to-r
    from-pink-500
    via-red-500
    to-yellow-500
    background-animate"
                >
                    <div className="max-w-md sm:max-w-lg md:sm:max-w-2xl lg:sm:max-w-3xl w-full space-y-8 text-center">
                        ...
                        >
                            Hey <span className="inline-block origin-70 hover:animate-wave">👋</span> I&apos;m Samuele
                        </Animate>
                ...
                <div className="flex flex-col gap-2 m-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="opacity-80 pb-12">
                            I use a wide range of tools to tackle each hurdle in the most efficient manner possible. I
                            really love working with Next.js, with TS implementing trpc... it's proven to be a reliable
                        ...
                        <ul className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                            ...
                            <ListItem icon={SiTypescript} text="TS" />
