                    ...
                    <Text>
                        <motion.div variants={anims.FadeContainer} initial="hidden" animate="visible">
                            <motion.p variants={anims.Fade}>
                                ...
                                learn stuff that I will actually use in my life. I made some Discord bots, wrote some
                                cool scripts. Eventually I got into web development and I love it, the frontend, the
                                backend, all of it. Lately I&apos;ve been dwelling into some Rust and Go as well because
                                I think thats the future. I haven&apos;t gotten into it a lot because frankly I have no
                                time.
                                <br />
                                <br />
                                ...
                                <a href="https://www.youtube.com/watch?v=wx_dnEen2xQ" rel="noreferrer" target="_blank">
                                    cardistry
                                </a>{' '}
