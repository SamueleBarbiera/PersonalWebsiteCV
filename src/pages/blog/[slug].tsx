...
import BlogElements from '../../components/Blog/Styles/Elements'
import BlogCode from '../../components/Blog/Styles/Code'
                    ...
                    <div className="relative px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex flex-col space-y-4 max-w-prose mx-auto my-4 text-lg text-center">
                            ...
                            <span className="flex justify-center items-center">
                                <PillDate>{post.frontmatter.date}</PillDate>
                            </span>
                        ...
                        <article className="max-w-prose mx-auto prose prose-primary prose-lg text-gray-500">
