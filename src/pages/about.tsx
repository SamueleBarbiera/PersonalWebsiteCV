                        ...
                        <Text>
                            <motion.div variants={anims.FadeContainer} initial="hidden" animate="visible">
                                <motion.p variants={anims.Fade}>
                                    ...
                                    live&nbsp;(for now) in India. We got Computer Science in our school in 5th grade,
                                    and since then it has been my favourite subject at school, even though they taught
                                    us Java which is not so enjoyable.
                                    <br />
                                    <br />
                                    In 2021 I started learning Python from{' '}
                                    <a href="https://www.freecodecamp.org/" rel="noreferrer" target="_blank">
                                        freeCodeCamp
                                    </a>{' '}
                                    in my free time because I felt like I was just wasting a lot of time, so I wanted to
                                    learn stuff that I will actually use in my life. I made some Discord bots, wrote
                                    some cool scripts. Eventually I got into web development and I love it, the
                                    frontend, the backend, all of it. Lately I&apos;ve been dwelling into some Rust and
                                    Go as well because I think thats the future. I haven&apos;t gotten into it a lot
                                    because frankly I have no time.
                                    <br />
                                    <br />
                                    ...
                                    which is an entrance exam for good engineering colleges in India, so most of my time
                                    goes into studying for it. I&apos;m hoping to study Computer Science in college.
                                    <br />
                                    <br />
                                    ...
                                    ,{' '}
                                    <a href="https://en.wikipedia.org/wiki/Mentalism" rel="noreferrer" target="_blank">
                                        mentalism
                                    </a>
                                    ...
                                    as well. I also like reading novels but I haven&apos;t read one for a long time now,
                                    simply because I have no time. My favourite author is{' '}
                                    <a href="https://en.wikipedia.org/wiki/John_Green" rel="noreferrer" target="_blank">
                                        John Green
                                    </a>
